...
filenames = ['phi_1000000.txt', 'phi_1000.txt', 'phi_100.txt', 'phi_30.txt' ]
...
hist = pygal.Bar()
for n in range(len_filenames):
	hist.add('N='+ str( len(pi_str[n]) ), norm_freq[n])

hist.x_labels  = list(domain)
hist.x_title = " Decimals"
hist.y_title = "%"
hist.title = "Distribution of Decimals in N digits of Phi"
